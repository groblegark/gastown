...
var versionChanges = []VersionChange{
	...
	},
	{
		...
		Changes: []string{
			...
			"FIX: Auto-recover from stale pane references",
	...
	},
	{
		...
		Date:    "2026-01-19",
		Changes: []string{
			"FIX: Orphan cleanup skips valid sessions - Prevents false kills of witnesses/refineries/deacon during startup by checking gt-*/hq-* session membership",
		},
	},
	{
		Version: "0.3.1",
	...
	},
	{
		...
		Date:    "2026-01-02",
		Changes: []string{
			"FIX: Keybindings scoped to Gas Town sessions only",
